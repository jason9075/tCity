...
import bpy
from .farmland import make_farmland, add_farmland_modifier, farmland_modifier, SOCKETS, PRESETS
...
LABELS={'Seed':'隨機種子','Plot Width':'田寬 (m)','Plot Length':'田長 (m)','Irregularity':'田形變化',
...
class TCITY_PT_farmland(bpy.types.Panel):
    ...
    def draw(self,context):
        ...
        headers={'Seed':'分割與田形','Rice Mix':'土地用途與生長階段','Farm Roads':'農路與灌溉','Crops':'模型與效能'};box=layout
...
CLASSES=(TCITY_OT_farm_demo,TCITY_OT_farm_generate,TCITY_OT_farm_seed,TCITY_OT_farm_preset,TCITY_PT_farmland)
