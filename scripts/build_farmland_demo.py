...
def build():
    ...
    set_control(mod,'Seed',31);set_control(mod,'Rice Mix',.62);set_control(mod,'Structure Mix',.13)
    ...
    if '--render' in sys.argv:
        ...
        for cam,name in [(aerial,'farmland_aerial'),(top,'farmland_plan'),(close,'farmland_detail')]:
